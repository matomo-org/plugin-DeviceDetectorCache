...
class CheckDirectDependencyUseCommandTest extends SystemTestCase
{
    public function testCommand()
    {
        ...
        $pluginName = 'DeviceDetectorCache';
        ...
        $this->assertEquals([
            'Symfony\Component\Console' => [
                'DeviceDetectorCache/tests/System/CheckDirectDependencyUseCommandTest.php'
            ],
            'DeviceDetector' => [
                'DeviceDetectorCache/CachedEntry.php',
                'DeviceDetectorCache/DeviceDetector/CachedBrowserParser.php',
                'DeviceDetectorCache/DeviceDetector/CachedOperatingSystemParser.php',
            ]
